...
export class TShape extends BaseShape {
    ...
    init(): void {
        ...
        this.keyCoordinations.push([new Coordination(1, position, 1), new Coordination(1, position + 1, 1), new Coordination(1, position + 2, 1)]);
